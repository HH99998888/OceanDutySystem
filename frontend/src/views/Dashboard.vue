...
<style scoped>
.title-row,.card-head{display:flex;align-items:center;justify-content:space-between}.title-row p{color:#7a8491}.alert{margin-bottom:12px}.card{margin-bottom:16px;min-height:112px}.website-card{min-height:140px}.site-metrics{display:grid;grid-template-columns:1fr 1fr 1.35fr;gap:12px;margin-top:22px}.site-metrics>div{border-left:3px solid #dcecff;padding-left:10px;min-width:0}.site-metrics span{display:block;color:#8894a4;font-size:12px}.site-metrics strong{display:block;color:#284b70;font-size:17px;margin:7px 0}.site-metrics .check-time{font-size:14px;white-space:nowrap}.grid-card{height:420px;overflow-y:auto}.card p{margin:18px 0 8px;color:#405266}.grid-card .ftp-label{margin:14px 0 4px;font-weight:600}small{color:#8894a4;word-break:break-all}.ftp-hint{display:block;margin-top:14px}h3{margin:30px 0 14px}@media(max-width:600px){.site-metrics{grid-template-columns:1fr}.site-metrics>div{padding:7px 10px}.website-card{min-height:0}}
</style>
